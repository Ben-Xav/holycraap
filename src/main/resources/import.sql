...
/* Item */
INSERT INTO `item` (name, price, slot, people_id) VALUES ('Dent de dragon', 100, 1, 1);
INSERT INTO `item` (name, price, slot, people_id) VALUES ('salicorne', 2, 1, 2);
INSERT INTO `item` (name, price, slot, people_id) VALUES ('gousse de mandragore', 5, 1, 3);
